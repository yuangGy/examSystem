...
<div id="dd" style="text-align: center;">
	...
	<form method="post" action="">
		<div class="panel admin-panel">
			...
			<table class="table table-hover text-center">
				...
				<c:forEach items="${manySubjects }" var="subject" varStatus="num">
					<tr>
					...
					<c:forEach items="${subject.options }" var="option">
						...
						<td><div class="button-group">
								<a class="button border-red" href="examMainController/deleteQuestion?questionId=${subject.questionId }"
									onclick="upadate()"><span class="icon-trash-o"></span>
									删除</a>
							</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="button-group">
								<a class="button border-red" href="examMainController/updateQuestionUI?questionId=${subject.questionId }?type=1"
									onclick="">
									修改</a>
							</div>
	...
	$("#add").click(function () {
		window.location.href="examMainController/addUI?type=1"
	})
		function del(id) {
			if (confirm("您确定要删除吗?")) {
